...
<section class="fxt-template-animation fxt-template-layout9" data-bg-image="img/figure/bg9-l.jpg">
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-6">
                <div class="fxt-content" style="text-align: center; color: white">
                    <h1 style="color: #FFA07A !important;">İstifadəçi şifrəsi səhvdir</h1>
                    <a href="index.php" type="submit" class="fxt-btn-fill" name="btn">Geri</a>
                </div>
            </div>
        </div>
    </div>
